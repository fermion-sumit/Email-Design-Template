...
class PlaceOrder implements ObserverInterface {
	...
	public function execute(\Magento\Framework\Event\Observer $observer) {
		...
		$html='	<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
									<tr>
										<td>
											<h1 style="text-align: center; color: #cf6c67; font-size: 1.375rem; margin:20px ;">THANK YOU FOR <br> SHOPING WITH US</h1>
										</td>
									</tr>		
								</table>
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;max-width: 600px !important;">
			<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
									<tr>
										<td>
											<h4 style="text-align: left; color: #000;  font-weight: normal; font-size: 1.000rem;">Hi '.$customerName.',</strong><br/></h4>

<p style="text-align: left; color: #000; font-weight: normal; font-size: 0.875rem; margin: 0; line-height: 22px;">
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
									<tr>
										<td>
									<h1 style="text-align: center; color: #cf6c67; font-size: 1.375rem; margin: 40px 0;">HERE\'S WHAT YOU ORDERED</h1>
										</td>
									</tr>
								</table>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
									<tr>
										<td>
											<h4 style="padding: 3px 10px; margin:0 0 -8px 10px; background-color: #FFF; position: relative; width: auto; float: left; font-size: 1.000rem;">ORDER# : 	<span style="font-weight: normal; font-size: 0.938rem;">'.$orderId.'<span style="font-weight: normal; font-size: 0.938rem;"></span></h4>
											 <h4 style="padding: 3px 0 3px 10px; margin:0 0 -8px 10px; background-color: #FFF; position: relative; width: auto; float: right; font-size: 1.000rem;"><span style=" font-weight: normal; font-size: 0.938rem;">'.round($totalItems).'  </span> ITEMS</h4>
				<span style="float: left; width: 100%; height: 1px; background-color: #000;"></span>
										</td>
									</tr>		
								</table>	</table>';
       ...
       $bagDiscount = 0;
		foreach($allItems as $item) {
            ...
            $est_delivery_date = date('jS F Y', $delivery_date);
				...
				$html .='<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;max-width: 600px !important;">
				<tbody>
				<table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="border-bottom: solid 1px #CCC;">
									<tr>
										<td>
											<img src="'.$image_url.'"  style="width: 80%; border:0; float: left;"></td>
					...
					padding-top: 10%;">
								...
								<p style="margin-top:18px font-size: 1em;margin:0px;margin-bottom:5px">QTY:'.$qty.'</p>
...
//$shippingAddress = $order->getShippingAddress()->getData();
		$html .= '<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;max-width: 600px !important;">
            <tbody>
            	<table width="100%" style="border-top:1px solid #FFF;border-bottom: 1px solid #FFF;">
		<tr style="border: none;display: inline-block;
    width: 100%; color:#f38379; padding:20px 0px;"><td>'.$offerText.'</td></tr></table>
	<tr>
        <td></td>
        ...
        <p>'.$methodTitle.'</p>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;max-width: 600px !important;border-top: 1px solid #000 ">
            <tbody>
						<table width="100%" class="address" style="font-size: 0.875em;
								margin-top:10px; ">
							<tr style=";display: inline-block;margin-bottom: 30px;padding-bottom: 20px;">
								<td width="50%">
